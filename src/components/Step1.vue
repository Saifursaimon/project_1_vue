...
import { ElInput, ElCheckbox, ElSelect, ElOption, ElCheckboxGroup, } from "element-plus";
                        ...
                        <div class="flex flex-col md:flex-row md:items-center gap-3 md:gap-6">
                            ...
                            <div class="flex items-center w-full">
                                ...
                                <el-input v-model="stepData.contactPerson.phone" clearable type="number"
                                    placeholder="请输入联系方式" class=" md:px-6 py-3.5 rounded-lg custom-input" />
                            </div>
                ...
                <div class="flex flex-col md:flex-row md:items-center gap-3 md:gap-12 mt-10 md:mt-0">
                    ...
                    <div class="md:w-1/2 grid grid-cols-2 md:grid-cols-5  gap-8 md:gap-2 mt-5 md:mt-0 ">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center gap-3 md:col-span-2">
                            ...
                            <el-input v-if="stepData.discussionPlatform.other"
                                v-model="stepData.discussionPlatform.otherText" placeholder="请填写其他开发生态"
                                class="custom-input " />
                        </div>
                    </div>
                </div>
